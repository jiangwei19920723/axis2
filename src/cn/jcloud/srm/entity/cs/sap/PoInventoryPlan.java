 ...
 * 备货计划
* @author 蒋维
* @date 创建时间：2018年4月9日 上午9:43:36
* @version 1.0
*/
@Entity
@Table(name="po_inventory_plan")
public class PoInventoryPlan {
	@Id
	@Column(name="plan_id")
	@GeneratedValue(strategy=GenerationType.SEQUENCE,generator="intId")
	@SequenceGenerator(name="intId",sequenceName="seq_pip_id",allocationSize=1)
	private Long id;
	...
	private String distrib_type;//配送方式（SAP字典表）
	...
	private Integer modify_status;//变更状态
	private Integer confirm_status;//确认状态
	private String date_type;//计划类型（W1、W2、W3、W4、M等）
	private Integer send_status;//接口同步状态
	public Long getId() {
		return id;
	}
