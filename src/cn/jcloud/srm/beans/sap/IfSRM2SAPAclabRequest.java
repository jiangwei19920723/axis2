 ...
 * @return  
 */
public class IfSRM2SAPAclabRequest {
	private String ebeln;
	private String lifnr;
	private String name;
	private String docNum;
	private String labDate;
	private List<IfSRM2SAPAclabLineItem> list;
	...
	public List<IfSRM2SAPAclabLineItem> getList() {
		return list;
	}
	public void setList(List<IfSRM2SAPAclabLineItem> list) {
		this.list = list;
	}
